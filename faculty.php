...
Edit Modal
    ...
    <div style="height: 520px;" class="container d-flex justify-content-center align-items-center my-4 ">
        <button class="btn d-flex mx-4 justify-content-center align-items-center shadow text"
            style="height:100px;width:100px;" data-toggle="modal" data-target="#facultySignupModal">SignUp</button>
        <button class="btn d-flex mx-4 justify-content-center align-items-center shadow text"
            style="height:100px;width:100px;" data-toggle="modal" data-target="#facultyLoginModal">Login</button>
    </div>
