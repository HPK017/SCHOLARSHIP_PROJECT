...
<body>
    ...
    <div class="container my-0">
        ...
        <ul class="list-group my-4">
            <span class="text-right my-4"  style="color: white;"><strong class="shadow p-3 mb-5 bg-dark rounded">Faculty: <?php echo $_SESSION['facultyemail']; ?></strong></span>
        </ul>
        <h1 class="text-center heading">Evaluate Scolarships</h1>
        ...
        <a href="partials/_facultyLogout.php" class="btn my-4 shadow-sm heading">Logout</a>
    </div>
    </div>
    ...
    Array.from(deletes).forEach((element) => {
        element.addEventListener("click", (e) => {
            ...
            if (confirm("Are you sure you want to remove this application?")) {
                console.log("yes");
                window.location = `/forum/facultyDetails.php?delete=${sno}`;
